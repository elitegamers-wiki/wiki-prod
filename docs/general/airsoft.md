...
.eg-airsoft-container {
  ...
  padding: 25px 35px;
  box-shadow: 0 0 10px rgba(179, 58, 58, 0.4);
}
...
.eg-airsoft img {
  ...
  max-width: 100%;
  cursor: zoom-in;
  box-shadow: 0 0 6px rgba(179, 58, 58, 0.3);
  transition: box-shadow 0.3s ease;
}

.eg-airsoft img:hover {
  box-shadow: 0 0 12px rgba(179, 58, 58, 0.7);
}
...
<div class="eg-airsoft-container eg-airsoft">

  <h1 class="eg-airsoft-title">AIRSOFT SYSTEM</h1>

  <p>Pe server-ul nostru de Fivem găsești o gramadă de lucruri de făcut, în special când e vorba de bătaie și acțiune!  
