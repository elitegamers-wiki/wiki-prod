...
# <center><span style="font-family: Conthrax; background: -webkit-linear-gradient(#8B0000, #2C0000); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">VIAȚA ILEGALĂ - INTRODUCERE</span></center>

<center><i>De la stradă la imperiu - Parcursul complet al unei organizații criminale</i></center>
